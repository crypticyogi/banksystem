function click1(a1,counter,a2,arrk,val,valbal){
	...
	tb.appendChild(div);
	div.innerHTML="<span style='color:white;margin-top: 50px'>Select the reciever</span>";
	...
	div1.innerHTML="<span style='color:white;margin-top: '>Select Amount you want to sent</span>";
